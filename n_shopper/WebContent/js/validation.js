...
// 各選択肢にバリデーションをかける
activateExistingMailValidation('email_outline', 'email', 'main_form', 'subm');

activateValidation('name_outline', 'name', 'main_form', 'subm');
activateRadioValidation('gender_outline', 'gender', 'invalid-feedback-gender', 'main_form', 'subm');
activateValidation('region_outline', 'region', 'main_form', 'subm');
activateValidation('prefecture_outline', 'prefecture', 'main_form', 'subm');
activateValidation('area_outline', 'area', 'main_form', 'subm');
