		...
		<div class="">
			<div class="row g-3 my-3">
				<div class="col col-lg-2">
					<div class="p-2 rounded-pill border bg-light text-center">ユーザー名（他ユーザーの画面でのみ出す）</div>
				</div>
				<div class="col col-lg-2">
					<div class="p-2 rounded-pill border bg-light text-center">エリア（他ユーザーの画面でのみ出す）</div>
				</div>
			</div>
			<div class="row g-3">
				<div class="col col-lg-2">
					<div class="p-2 rounded-pill border bg-light text-center">フォロー</div>
				</div>
				<div class="col col-lg-2">
					<div class="p-2 rounded-pill border bg-light text-center">フォロワー</div>
				</div>
				<div class="col-lg-2">
					<div class="p-2 rounded-pill border bg-light text-center">人気ユーザーをチェック</div>
				</div>
			</div>
			<br>
			<nav>
			...
			<div class="tab-content" id="nav-tabContent">
				...
				<button type="button" class="btn btn-primary col-3 mx-2"
					value="お気に入り登録">検索する</button>
			</div>
		</div>
	</div>
