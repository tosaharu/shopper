		...
		<div
			...
			<form action="/shopper/U_RegisterUser" method="post" id="main_form">
				...
				<div class="form-outline mb-1" id="pass2_outline">
					<label class="form-label" for="password2">パスワード（再入力）</label> <input
				...
				<div class="form-outline mb-1" id="name_outline">
					<label class="form-label" for="name">ユーザー名</label> <input
						type="text" id="name" class="form-control" name="name"
						required="required" placeholder="ユーザー名" />
						...
						<div id="gender">
							<div class="form-check form-check-inline">
								<input class="form-check-input" type="radio" name="gender"
									id="male" value="1" required> <label
									class="form-check-label" for="male"> 男性 </label>
							</div>
							<div class="form-check form-check-inline">
								<input class="form-check-input" type="radio" name="gender"
									id="female" value="2" required> <label
									class="form-check-label" for="female"> 女性 </label>
							</div>
							<div class="form-check form-check-inline">
								<input class="form-check-input" type="radio" name="gender"
									id="other" value="3" required> <label
